const s={frontmatter:{title:"Create Your First Site",description:"A step-by-step tutorial that walks you through creating a documentation site with Tome, from installation to running the dev server.",icon:"rocket",hidden:!1,toc:!0,draft:!1},html:`<p>This tutorial walks you through creating a Tome documentation site from scratch. By the end, you'll have a working docs site running locally with custom pages and navigation.</p>
...
<p>You need <strong>Node.js 20+</strong> and a package manager (<code>npm</code>, <code>yarn</code>, or <code>pnpm</code>).</p>
...
<ul>
<li><strong><a href="tutorials/deploy-to-cloud">Deploy to Tome Cloud</a></strong> to publish with a single command</li>
<li><strong><a href="guides/configuration">Configuration guide</a></strong> for all available options</li>
<li><strong><a href="reference/components">Components reference</a></strong> for the full list of MDX components</li>
