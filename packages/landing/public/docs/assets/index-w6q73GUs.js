 ...
 */var Hf;function yh(){if(Hf)return $l;Hf=1;var d=Symbol.for("react.transitional.element"),M=Symbol.for("react.fragment");function y(s,_,O){var R=null;if(O!==void 0&&(R=""+O),_.key!==void 0&&(R=""+_.key),"key"in _){O={};for(var U in _)U!=="key"&&(O[U]=_[U])}else O=_;return _=O.ref,{$$typeof:d,type:s,key:R,ref:_!==void 0?_:null,props:O}}return $l.Fragment=M,$l.jsx=y,$l.jsxs=y,$l}var Lf;function bh(){return Lf||(Lf=1,qr.exports=yh()),qr.exports}var r=bh(),Hr={exports:{}},ee={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nf;function xh(){if(Nf)return ee;Nf=1;var d=Symbol.for("react.transitional.element"),M=Symbol.for("react.portal"),y=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),_=Symbol.for("react.profiler"),O=Symbol.for("react.consumer"),R=Symbol.for("react.context"),U=Symbol.for("react.forward_ref"),C=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),X=Symbol.for("react.lazy"),D=Symbol.for("react.activity"),q=Symbol.iterator;function W(m){return m===null||typeof m!="object"?null:(m=q&&m[q]||m["@@iterator"],typeof m=="function"?m:null)}var oe={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},I=Object.assign,ue={};function k(m,j,B){this.props=m,this.context=j,this.refs=ue,this.updater=B||oe}k.prototype.isReactComponent={},k.prototype.setState=function(m,j){if(typeof m!="object"&&typeof m!="function"&&m!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,m,j,"setState")},k.prototype.forceUpdate=function(m){this.updater.enqueueForceUpdate(this,m,"forceUpdate")};function ie(){}ie.prototype=k.prototype;function me(m,j,B){this.props=m,this.context=j,this.refs=ue,this.updater=B||oe}var K=me.prototype=new ie;K.constructor=me,I(K,k.prototype),K.isPureReactComponent=!0;var Me=Array.isArray;function ye(){}var J={H:null,A:null,T:null,S:null},ne=Object.prototype.hasOwnProperty;function lt(m,j,B){var N=B.ref;return{$$typeof:d,type:m,key:j,ref:N!==void 0?N:null,props:B}}function it(m,j){return lt(m.type,j,m.props)}function ot(m){return typeof m=="object"&&m!==null&&m.$$typeof===d}function Je(m){var j={"=":"=0",":":"=2"};return"$"+m.replace(/[=:]/g,function(B){return j[B]})}var ut=/\/+/g;function qt(m,j){return typeof m=="object"&&m!==null&&m.key!=null?Je(""+m.key):j.toString(36)}function st(m){switch(m.status){case"fulfilled":return m.value;case"rejected":throw m.reason;default:switch(typeof m.status=="string"?m.then(ye,ye):(m.status="pending",m.then(function(j){m.status==="pending"&&(m.status="fulfilled",m.value=j)},function(j){m.status==="pending"&&(m.status="rejected",m.reason=j)})),m.status){case"fulfilled":return m.value;case"rejected":throw m.reason}}throw m}function A(m,j,B,N,$){var le=typeof m;(le==="undefined"||le==="boolean")&&(m=null);var re=!1;if(m===null)re=!0;else switch(le){case"bigint":case"string":case"number":re=!0;break;case"object":switch(m.$$typeof){case d:case M:re=!0;break;case X:return re=m._init,A(re(m._payload),j,B,N,$)}}if(re)return $=$(m),re=N===""?"."+qt(m,0):N,Me($)?(B="",re!=null&&(B=re.replace(ut,"$&/")+"/"),A($,j,B,"",function(gn){return gn})):$!=null&&(ot($)&&($=it($,B+($.key==null||m&&m.key===$.key?"":(""+$.key).replace(ut,"$&/")+"/")+re)),j.push($)),1;re=0;var Fe=N===""?".":N+":";if(Me(m))for(var Re=0;Re<m.length;Re++)N=m[Re],le=Fe+qt(N,Re),re+=A(N,j,B,le,$);else if(Re=W(m),typeof Re=="function")for(m=Re.call(m),Re=0;!(N=m.next()).done;)N=N.value,le=Fe+qt(N,Re++),re+=A(N,j,B,le,$);else if(le==="object"){if(typeof m.then=="function")return A(st(m),j,B,N,$);throw j=String(m),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(m).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return re}function w(m,j,B){if(m==null)return m;var N=[],$=0;return A(m,N,"","",function(le){return j.call(B,le,$++)}),N}function Z(m){if(m._status===-1){var j=m._result;j=j(),j.then(function(B){(m._status===0||m._status===-1)&&(m._status=1,m._result=B)},function(B){(m._status===0||m._status===-1)&&(m._status=2,m._result=B)}),m._status===-1&&(m._status=0,m._result=j)}if(m._status===1)return m._result.default;throw m._result}var he=typeof reportError=="function"?reportError:function(m){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof m=="object"&&m!==null&&typeof m.message=="string"?String(m.message):String(m),error:m});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",m);return}console.error(m)},Se={map:w,forEach:function(m,j,B){w(m,function(){j.apply(this,arguments)},B)},count:function(m){var j=0;return w(m,function(){j++}),j},toArray:function(m){return w(m,function(j){return j})||[]},only:function(m){if(!ot(m))throw Error("React.Children.only expected to receive a single React element child.");return m}};return ee.Activity=D,ee.Children=Se,ee.Component=k,ee.Fragment=y,ee.Profiler=_,ee.PureComponent=me,ee.StrictMode=s,ee.Suspense=C,ee.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=J,ee.__COMPILER_RUNTIME={__proto__:null,c:function(m){return J.H.useMemoCache(m)}},ee.cache=function(m){return function(){return m.apply(null,arguments)}},ee.cacheSignal=function(){return null},ee.cloneElement=function(m,j,B){if(m==null)throw Error("The argument must be a React element, but you passed "+m+".");var N=I({},m.props),$=m.key;if(j!=null)for(le in j.key!==void 0&&($=""+j.key),j)!ne.call(j,le)||le==="key"||le==="__self"||le==="__source"||le==="ref"&&j.ref===void 0||(N[le]=j[le]);var le=arguments.length-2;if(le===1)N.children=B;else if(1<le){for(var re=Array(le),Fe=0;Fe<le;Fe++)re[Fe]=arguments[Fe+2];N.children=re}return lt(m.type,$,N)},ee.createContext=function(m){return m={$$typeof:R,_currentValue:m,_currentValue2:m,_threadCount:0,Provider:null,Consumer:null},m.Provider=m,m.Consumer={$$typeof:O,_context:m},m},ee.createElement=function(m,j,B){var N,$={},le=null;if(j!=null)for(N in j.key!==void 0&&(le=""+j.key),j)ne.call(j,N)&&N!=="key"&&N!=="__self"&&N!=="__source"&&($[N]=j[N]);var re=arguments.length-2;if(re===1)$.children=B;else if(1<re){for(var Fe=Array(re),Re=0;Re<re;Re++)Fe[Re]=arguments[Re+2];$.children=Fe}if(m&&m.defaultProps)for(N in re=m.defaultProps,re)$[N]===void 0&&($[N]=re[N]);return lt(m,le,$)},ee.createRef=function(){return{current:null}},ee.forwardRef=function(m){return{$$typeof:U,render:m}},ee.isValidElement=ot,ee.lazy=function(m){return{$$typeof:X,_payload:{_status:-1,_result:m},_init:Z}},ee.memo=function(m,j){return{$$typeof:b,type:m,compare:j===void 0?null:j}},ee.startTransition=function(m){var j=J.T,B={};J.T=B;try{var N=m(),$=J.S;$!==null&&$(B,N),typeof N=="object"&&N!==null&&typeof N.then=="function"&&N.then(ye,he)}catch(le){he(le)}finally{j!==null&&B.types!==null&&(j.types=B.types),J.T=j}},ee.unstable_useCacheRefresh=function(){return J.H.useCacheRefresh()},ee.use=function(m){return J.H.use(m)},ee.useActionState=function(m,j,B){return J.H.useActionState(m,j,B)},ee.useCallback=function(m,j){return J.H.useCallback(m,j)},ee.useContext=function(m){return J.H.useContext(m)},ee.useDebugValue=function(){},ee.useDeferredValue=function(m,j){return J.H.useDeferredValue(m,j)},ee.useEffect=function(m,j){return J.H.useEffect(m,j)},ee.useEffectEvent=function(m){return J.H.useEffectEvent(m)},ee.useId=function(){return J.H.useId()},ee.useImperativeHandle=function(m,j,B){return J.H.useImperativeHandle(m,j,B)},ee.useInsertionEffect=function(m,j){return J.H.useInsertionEffect(m,j)},ee.useLayoutEffect=function(m,j){return J.H.useLayoutEffect(m,j)},ee.useMemo=function(m,j){return J.H.useMemo(m,j)},ee.useOptimistic=function(m,j){return J.H.useOptimistic(m,j)},ee.useReducer=function(m,j,B){return J.H.useReducer(m,j,B)},ee.useRef=function(m){return J.H.useRef(m)},ee.useState=function(m){return J.H.useState(m)},ee.useSyncExternalStore=function(m,j,B){return J.H.useSyncExternalStore(m,j,B)},ee.useTransition=function(){return J.H.useTransition()},ee.version="19.2.4",ee}var kf;function Vr(){return kf||(kf=1,Hr.exports=xh()),Hr.exports}var H=Vr();const Sh=vh(H);var Lr={exports:{}},Pl={},Nr={exports:{}},kr={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gf;function Th(){return Gf||(Gf=1,(function(d){function M(A,w){var Z=A.length;A.push(w);e:for(;0<Z;){var he=Z-1>>>1,Se=A[he];if(0<_(Se,w))A[he]=w,A[Z]=Se,Z=he;else break e}}function y(A){return A.length===0?null:A[0]}function s(A){if(A.length===0)return null;var w=A[0],Z=A.pop();if(Z!==w){A[0]=Z;e:for(var he=0,Se=A.length,m=Se>>>1;he<m;){var j=2*(he+1)-1,B=A[j],N=j+1,$=A[N];if(0>_(B,Z))N<Se&&0>_($,B)?(A[he]=$,A[N]=Z,he=N):(A[he]=B,A[j]=Z,he=j);else if(N<Se&&0>_($,Z))A[he]=$,A[N]=Z,he=N;else break e}}return w}function _(A,w){var Z=A.sortIndex-w.sortIndex;return Z!==0?Z:A.id-w.id}if(d.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var O=performance;d.unstable_now=function(){return O.now()}}else{var R=Date,U=R.now();d.unstable_now=function(){return R.now()-U}}var C=[],b=[],X=1,D=null,q=3,W=!1,oe=!1,I=!1,ue=!1,k=typeof setTimeout=="function"?setTimeout:null,ie=typeof clearTimeout=="function"?clearTimeout:null,me=typeof setImmediate<"u"?setImmediate:null;function K(A){for(var w=y(b);w!==null;){if(w.callback===null)s(b);else if(w.startTime<=A)s(b),w.sortIndex=w.expirationTime,M(C,w);else break;w=y(b)}}function Me(A){if(I=!1,K(A),!oe)if(y(C)!==null)oe=!0,ye||(ye=!0,Je());else{var w=y(b);w!==null&&st(Me,w.startTime-A)}}var ye=!1,J=-1,ne=5,lt=-1;function it(){return ue?!0:!(d.unstable_now()-lt<ne)}function ot(){if(ue=!1,ye){var A=d.unstable_now();lt=A;var w=!0;try{e:{oe=!1,I&&(I=!1,ie(J),J=-1),W=!0;var Z=q;try{t:{for(K(A),D=y(C);D!==null&&!(D.expirationTime>A&&it());){var he=D.callback;if(typeof he=="function"){D.callback=null,q=D.priorityLevel;var Se=he(D.expirationTime<=A);if(A=d.unstable_now(),typeof Se=="function"){D.callback=Se,K(A),w=!0;break t}D===y(C)&&s(C),K(A)}else s(C);D=y(C)}if(D!==null)w=!0;else{var m=y(b);m!==null&&st(Me,m.startTime-A),w=!1}}break e}finally{D=null,q=Z,W=!1}w=void 0}}finally{w?Je():ye=!1}}}var Je;if(typeof me=="function")Je=function(){me(ot)};else if(typeof MessageChannel<"u"){var ut=new MessageChannel,qt=ut.port2;ut.port1.onmessage=ot,Je=function(){qt.postMessage(null)}}else Je=function(){k(ot,0)};function st(A,w){J=k(function(){A(d.unstable_now())},w)}d.unstable_IdlePriority=5,d.unstable_ImmediatePriority=1,d.unstable_LowPriority=4,d.unstable_NormalPriority=3,d.unstable_Profiling=null,d.unstable_UserBlockingPriority=2,d.unstable_cancelCallback=function(A){A.callback=null},d.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ne=0<A?Math.floor(1e3/A):5},d.unstable_getCurrentPriorityLevel=function(){return q},d.unstable_next=function(A){switch(q){case 1:case 2:case 3:var w=3;break;default:w=q}var Z=q;q=w;try{return A()}finally{q=Z}},d.unstable_requestPaint=function(){ue=!0},d.unstable_runWithPriority=function(A,w){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var Z=q;q=A;try{return w()}finally{q=Z}},d.unstable_scheduleCallback=function(A,w,Z){var he=d.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?he+Z:he):Z=he,A){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=Z+Se,A={id:X++,callback:w,priorityLevel:A,startTime:Z,expirationTime:Se,sortIndex:-1},Z>he?(A.sortIndex=Z,M(b,A),y(C)===null&&A===y(b)&&(I?(ie(J),J=-1):I=!0,st(Me,Z-he))):(A.sortIndex=Se,M(C,A),oe||W||(oe=!0,ye||(ye=!0,Je()))),A},d.unstable_shouldYield=it,d.unstable_wrapCallback=function(A){var w=q;return function(){var Z=q;q=w;try{return A.apply(this,arguments)}finally{q=Z}}}})(kr)),kr}var Yf;function Ah(){return Yf||(Yf=1,Nr.exports=Th()),Nr.exports}var Gr={exports:{}},at={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vf;function _h(){if(Vf)return at;Vf=1;var d=Vr();function M(C){var b="https://react.dev/errors/"+C;if(1<arguments.length){b+="?args[]="+encodeURIComponent(arguments[1]);for(var X=2;X<arguments.length;X++)b+="&args[]="+encodeURIComponent(arguments[X])}return"Minified React error #"+C+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function y(){}var s={d:{f:y,r:function(){throw Error(M(522))},D:y,C:y,L:y,m:y,X:y,S:y,M:y},p:0,findDOMNode:null},_=Symbol.for("react.portal");function O(C,b,X){var D=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:_,key:D==null?null:""+D,children:C,containerInfo:b,implementation:X}}var R=d.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function U(C,b){if(C==="font")return"";if(typeof b=="string")return b==="use-credentials"?b:""}return at.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,at.createPortal=function(C,b){var X=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!b||b.nodeType!==1&&b.nodeType!==9&&b.nodeType!==11)throw Error(M(299));return O(C,b,null,X)},at.flushSync=function(C){var b=R.T,X=s.p;try{if(R.T=null,s.p=2,C)return C()}finally{R.T=b,s.p=X,s.d.f()}},at.preconnect=function(C,b){typeof C=="string"&&(b?(b=b.crossOrigin,b=typeof b=="string"?b==="use-credentials"?b:"":void 0):b=null,s.d.C(C,b))},at.prefetchDNS=function(C){typeof C=="string"&&s.d.D(C)},at.preinit=function(C,b){if(typeof C=="string"&&b&&typeof b.as=="string"){var X=b.as,D=U(X,b.crossOrigin),q=typeof b.integrity=="string"?b.integrity:void 0,W=typeof b.fetchPriority=="string"?b.fetchPriority:void 0;X==="style"?s.d.S(C,typeof b.precedence=="string"?b.precedence:void 0,{crossOrigin:D,integrity:q,fetchPriority:W}):X==="script"&&s.d.X(C,{crossOrigin:D,integrity:q,fetchPriority:W,nonce:typeof b.nonce=="string"?b.nonce:void 0})}},at.preinitModule=function(C,b){if(typeof C=="string")if(typeof b=="object"&&b!==null){if(b.as==null||b.as==="script"){var X=U(b.as,b.crossOrigin);s.d.M(C,{crossOrigin:X,integrity:typeof b.integrity=="string"?b.integrity:void 0,nonce:typeof b.nonce=="string"?b.nonce:void 0})}}else b==null&&s.d.M(C)},at.preload=function(C,b){if(typeof C=="string"&&typeof b=="object"&&b!==null&&typeof b.as=="string"){var X=b.as,D=U(X,b.crossOrigin);s.d.L(C,X,{crossOrigin:D,integrity:typeof b.integrity=="string"?b.integrity:void 0,nonce:typeof b.nonce=="string"?b.nonce:void 0,type:typeof b.type=="string"?b.type:void 0,fetchPriority:typeof b.fetchPriority=="string"?b.fetchPriority:void 0,referrerPolicy:typeof b.referrerPolicy=="string"?b.referrerPolicy:void 0,imageSrcSet:typeof b.imageSrcSet=="string"?b.imageSrcSet:void 0,imageSizes:typeof b.imageSizes=="string"?b.imageSizes:void 0,media:typeof b.media=="string"?b.media:void 0})}},at.preloadModule=function(C,b){if(typeof C=="string")if(b){var X=U(b.as,b.crossOrigin);s.d.m(C,{as:typeof b.as=="string"&&b.as!=="script"?b.as:void 0,crossOrigin:X,integrity:typeof b.integrity=="string"?b.integrity:void 0})}else s.d.m(C)},at.requestFormReset=function(C){s.d.r(C)},at.unstable_batchedUpdates=function(C,b){return C(b)},at.useFormState=function(C,b,X){return R.H.useFormState(C,b,X)},at.useFormStatus=function(){return R.H.useHostTransitionStatus()},at.version="19.2.4",at}var Xf;function Eh(){if(Xf)return Gr.exports;Xf=1;function d(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(d)}catch(M){console.error(M)}}return d(),Gr.exports=_h(),Gr.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qf;function zh(){if(Qf)return Pl;Qf=1;var d=Ah(),M=Vr(),y=Eh();function s(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function _(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function O(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function R(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function U(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function C(e){if(O(e)!==e)throw Error(s(188))}function b(e){var t=e.alternate;if(!t){if(t=O(e),t===null)throw Error(s(188));return t!==e?null:e}for(var n=e,a=t;;){var l=n.return;if(l===null)break;var i=l.alternate;if(i===null){if(a=l.return,a!==null){n=a;continue}break}if(l.child===i.child){for(i=l.child;i;){if(i===n)return C(l),e;if(i===a)return C(l),t;i=i.sibling}throw Error(s(188))}if(n.return!==a.return)n=l,a=i;else{for(var o=!1,u=l.child;u;){if(u===n){o=!0,n=l,a=i;break}if(u===a){o=!0,a=l,n=i;break}u=u.sibling}if(!o){for(u=i.child;u;){if(u===n){o=!0,n=i,a=l;break}if(u===a){o=!0,a=i,n=l;break}u=u.sibling}if(!o)throw Error(s(189))}}if(n.alternate!==a)throw Error(s(190))}if(n.tag!==3)throw Error(s(188));return n.stateNode.current===n?e:t}function X(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=X(e),t!==null)return t;e=e.sibling}return null}var D=Object.assign,q=Symbol.for("react.element"),W=Symbol.for("react.transitional.element"),oe=Symbol.for("react.portal"),I=Symbol.for("react.fragment"),ue=Symbol.for("react.strict_mode"),k=Symbol.for("react.profiler"),ie=Symbol.for("react.consumer"),me=Symbol.for("react.context"),K=Symbol.for("react.forward_ref"),Me=Symbol.for("react.suspense"),ye=Symbol.for("react.suspense_list"),J=Symbol.for("react.memo"),ne=Symbol.for("react.lazy"),lt=Symbol.for("react.activity"),it=Symbol.for("react.memo_cache_sentinel"),ot=Symbol.iterator;function Je(e){return e===null||typeof e!="object"?null:(e=ot&&e[ot]||e["@@iterator"],typeof e=="function"?e:null)}var ut=Symbol.for("react.client.reference");function qt(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===ut?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case I:return"Fragment";case k:return"Profiler";case ue:return"StrictMode";case Me:return"Suspense";case ye:return"SuspenseList";case lt:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case oe:return"Portal";case me:return e.displayName||"Context";case ie:return(e._context.displayName||"Context")+".Consumer";case K:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case J:return t=e.displayName||null,t!==null?t:qt(e.type)||"Memo";case ne:t=e._payload,e=e._init;try{return qt(e(t))}catch{}}return null}var st=Array.isArray,A=M.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,w=y.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Z={pending:!1,data:null,method:null,action:null},he=[],Se=-1;function m(e){return{current:e}}function j(e){0>Se||(e.current=he[Se],he[Se]=null,Se--)}function B(e,t){Se++,he[Se]=e.current,e.current=t}var N=m(null),$=m(null),le=m(null),re=m(null);function Fe(e,t){switch(B(le,t),B($,e),B(N,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?lf(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=lf(t),e=of(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}j(N),B(N,e)}function Re(){j(N),j($),j(le)}function gn(e){e.memoizedState!==null&&B(re,e);var t=N.current,n=of(t,e.type);t!==n&&(B($,e),B(N,n))}function Vn(e){$.current===e&&(j(N),j($)),re.current===e&&(j(re),Jl._currentValue=Z)}var ha,We;function Ht(e){if(ha===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);ha=t&&t[1]||"",We=-1<n.stack.indexOf(`
...
`,Ao=(To.basePath||"/").replace(/\/$/,"");function zg(d){return am(d,Ao,pa)}function Pf(d){return tg(d,Ao,pa)}function Mg(){const[d,M]=H.useState(()=>ag(window.location.pathname,window.location.hash,pa,Ao,am)),[y,s]=H.useState(null),[_,O]=H.useState(!0),R=H.useCallback(async(D,q)=>{O(!0),M(D);const W=Pf(D);q!=null&&q.replace?window.history.replaceState(null,"",W):window.history.pushState(null,"",W);const oe=await lg(D,pa,rg);if(s(oe),O(!1),!(q!=null&&q.skipScroll)){const I=window.location.hash.slice(1);I?requestAnimationFrame(()=>{const ue=document.getElementById(I);ue&&ue.scrollIntoView({behavior:"smooth",block:"start"})}):window.scrollTo(0,0)}},[]);H.useEffect(()=>{const D=window.location.hash.slice(1);if(D&&pa.some(q=>q.id===D)){const q=Pf(D);window.history.replaceState(null,"",q),R(D,{replace:!0})}else R(d,{replace:!0,skipScroll:!0})},[]),H.useEffect(()=>{const D=()=>{const q=zg(window.location.pathname);q&&q!==d&&R(q,{replace:!0,skipScroll:!0})};return window.addEventListener("popstate",D),()=>window.removeEventListener("popstate",D)},[d,R]),H.useEffect(()=>{const D=document.querySelectorAll(".tome-mermaid[data-mermaid]");if(D.length===0)return;let q=!1;const W="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs";return(async()=>{try{const{default:oe}=await import(W);if(q)return;const I=document.documentElement.classList.contains("dark"),ue=getComputedStyle(document.documentElement).getPropertyValue("--font-body").trim()||"sans-serif";oe.initialize({startOnLoad:!1,theme:I?"dark":"default",fontFamily:ue,flowchart:{padding:15,nodeSpacing:30,rankSpacing:40}});for(let k=0;k<D.length;k++){const ie=D[k];if(ie.querySelector("svg"))continue;const me=ie.getAttribute("data-mermaid");if(me)try{const K=atob(me),{svg:Me}=await oe.render(`tome-mermaid-${k}-${Date.now()}`,K);if(!q)try{const ye=(await V(async()=>{const{default:J}=await import("https://cdn.jsdelivr.net/npm/dompurify@3/dist/purify.es.mjs");return{default:J}},[])).default;ie.innerHTML=ye.sanitize(Me,{USE_PROFILES:{html:!0,svg:!0,svgFilters:!0}})}catch{ie.innerHTML=Me}}catch(K){console.warn("[tome] Mermaid render failed:",K),ie.textContent="Diagram rendering failed",ie.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"}}}catch(oe){console.warn("[tome] Failed to load mermaid from CDN:",oe),D.forEach(I=>{I.textContent="Failed to load diagram renderer",I.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"})}})(),()=>{q=!0}},[y,_]);const U=pa.map(D=>({id:D.id,title:D.frontmatter.title,description:D.frontmatter.description})),C=pa.find(D=>D.id===d),b=ig(C,Wf),X=ng(To.editLink,C==null?void 0:C.filePath);return H.useEffect(()=>{if(!To.math)return;const D="tome-katex-css";if(document.getElementById(D))return;const q=document.createElement("link");q.id=D,q.rel="stylesheet",q.href="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.min.css",q.crossOrigin="anonymous",document.head.appendChild(q)},[]),r.jsxs(r.Fragment,{children:[r.jsx("style",{children:Eg}),r.jsx(Ph,{config:To,navigation:og,currentPageId:d,pageHtml:y!=null&&y.isMdx?void 0:_?"<p>Loading...</p>":(y==null?void 0:y.html)||"<p>Page not found</p>",pageComponent:y!=null&&y.isMdx?y.component:void 0,mdxComponents:_g,pageTitle:(y==null?void 0:y.frontmatter.title)||(_?"Loading...":"Not Found"),pageDescription:y==null?void 0:y.frontmatter.description,headings:(y==null?void 0:y.headings)||[],tocEnabled:(y==null?void 0:y.frontmatter.toc)!==!1,editUrl:X,lastUpdated:C==null?void 0:C.lastUpdated,changelogEntries:y!=null&&y.isMdx||y==null?void 0:y.changelogEntries,onNavigate:R,allPages:U,docContext:cg,versioning:Wf||void 0,currentVersion:b,basePath:Ao})]})}const em=document.getElementById("tome-root");em&&jh.createRoot(em).render(r.jsx(Mg,{}));export{H as a,Sh as e,r as j,Eh as r};
