...
<ul>
<li><strong><a href="v2/quickstart">Quickstart</a></strong> — Get a docs site running in under a minute.</li>
<li><strong><a href="v2/installation">Installation</a></strong> — Detailed setup instructions and prerequisites.</li>
<li><strong><a href="v2/configuration">Configuration</a></strong> — Customize your site name, navigation, theme, and more.</li>
<li><strong><a href="v2/cli">CLI Reference</a></strong> — Every command and flag available in the <code>tome</code> CLI.</li>
...
- **[Quickstart](v2/quickstart)** — Get a docs site running in under a minute.
- **[Installation](v2/installation)** — Detailed setup instructions and prerequisites.
- **[Configuration](v2/configuration)** — Customize your site name, navigation, theme, and more.
- **[CLI Reference](v2/cli)** — Every command and flag available in the \`tome\` CLI.
`};export{e as default};
