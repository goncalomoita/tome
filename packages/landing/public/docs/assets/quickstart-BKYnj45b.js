const n={frontmatter:{title:"Quickstart",description:"Get a Tome documentation site running in under a minute.",icon:"zap",hidden:!1,toc:!0,draft:!1},html:`<p>Get a working documentation site in three commands.</p>
...
<ul>
<li><strong><a href="v1/installation">Installation</a></strong> for detailed setup and prerequisites</li>
<li><strong><a href="v1/configuration">Configuration</a></strong> to customize your site</li>
<li><strong><a href="v1/components">Components</a></strong> to use tabs, callouts, and other interactive elements</li>
...
- **[Installation](v1/installation)** for detailed setup and prerequisites
- **[Configuration](v1/configuration)** to customize your site
- **[Components](v1/components)** to use tabs, callouts, and other interactive elements
`};export{n as default};
