...
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">  },</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">},</span></span></code></pre>
<p>See <strong><a href="v1/theming">Theming</a></strong> for full customization details.</p>
...
<p>Enable LaTeX math support with KaTeX:</p>
...
<p>Once enabled, you can use inline math with <code>$E = mc^2$</code> and display math with <code>$$</code> blocks in your Markdown pages. Requires <code>remark-math</code>, <code>rehype-katex</code>, and <code>katex</code> as peer dependencies:</p>
...
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">\`\`\`</span></span></code></pre>
<p>Diagrams are rendered client-side and automatically adapt to your site's light/dark theme.</p>
<h2 id="ai-discoverability"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#ai-discoverability"><span class="icon icon-link"></span></a>AI discoverability</h2>
<p>Tome automatically generates two files at build time to make your docs accessible to AI tools:</p>
<ul>
<li><strong><code>llms.txt</code></strong> — A page index with titles, descriptions, and URLs</li>
<li><strong><code>llms-full.txt</code></strong> — Full raw Markdown content of all non-hidden pages</li>
</ul>
<p>These are always generated — no configuration needed. Hidden pages (with <code>hidden: true</code> in frontmatter) are excluded.</p>
...
See **[Theming](v1/theming)** for full customization details.
