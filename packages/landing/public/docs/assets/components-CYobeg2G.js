const n={frontmatter:{title:"Components",description:"Reference for all built-in MDX components — Callout, Tabs, Card, Steps, Accordion, and more.",icon:"puzzle",hidden:!1,toc:!0,draft:!1},html:`<p>Tome includes built-in components available in any <code>.mdx</code> file without imports.</p>
...
<p>See the <a href="guides/api-reference">API reference guide</a> for setup.</p>
<hr>
