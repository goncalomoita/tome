...
<p>When migrating from GitBook or Mintlify, the migration tools automatically extract redirects from the source project configuration and add them to your <code>tome.config.js</code>. See the <a href="guides/migration">Migration guide</a> for details.</p>`,headings:[{depth:2,text:"Config-level redirects",id:"config-level-redirects"},{depth:2,text:"Frontmatter redirects",id:"frontmatter-redirects"},{depth:2,text:"How redirects work",id:"how-redirects-work"},{depth:3,text:"Development",id:"development"},{depth:3,text:"Production builds",id:"production-builds"},{depth:2,text:"Migration redirects",id:"migration-redirects"}],raw:`
