const e={frontmatter:{title:"Introduction",description:"Tome is an open-source documentation platform for Markdown and MDX. Beautiful docs without the $250/month price tag.",hidden:!1,toc:!0,draft:!1},html:`<h1 id="tome"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#tome"><span class="icon icon-link"></span></a>Tome</h1>
...
<span class="line"><span style="color:#005CC5;--shiki-dark:#79B8FF">cd</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> my-docs</span><span style="color:#24292E;--shiki-dark:#E1E4E8"> &amp;&amp; </span><span style="color:#6F42C1;--shiki-dark:#B392F0">npm</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> install</span><span style="color:#24292E;--shiki-dark:#E1E4E8"> &amp;&amp; </span><span style="color:#6F42C1;--shiki-dark:#B392F0">npm</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> run</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> dev</span></span></code></pre>
...
<ul>
<li><strong><a href="v1/quickstart">Quickstart</a></strong> — Get a docs site running in under a minute.</li>
<li><strong><a href="v1/installation">Installation</a></strong> — Detailed setup instructions and prerequisites.</li>
<li><strong><a href="v1/configuration">Configuration</a></strong> — Customize your site name, navigation, theme, and more.</li>
<li><strong><a href="v1/cli">CLI Reference</a></strong> — Every command and flag available in the <code>tome</code> CLI.</li>
...
- **[Quickstart](v1/quickstart)** — Get a docs site running in under a minute.
- **[Installation](v1/installation)** — Detailed setup instructions and prerequisites.
- **[Configuration](v1/configuration)** — Customize your site name, navigation, theme, and more.
- **[CLI Reference](v1/cli)** — Every command and flag available in the \`tome\` CLI.
`};export{e as default};
