(function(){const z=document.createElement("link").relList;if(z&&z.supports&&z.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))s(A);new MutationObserver(A=>{for(const O of A)if(O.type==="childList")for(const R of O.addedNodes)R.tagName==="LINK"&&R.rel==="modulepreload"&&s(R)}).observe(document,{childList:!0,subtree:!0});function v(A){const O={};return A.integrity&&(O.integrity=A.integrity),A.referrerPolicy&&(O.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?O.credentials="include":A.crossOrigin==="anonymous"?O.credentials="omit":O.credentials="same-origin",O}function s(A){if(A.ep)return;A.ep=!0;const O=v(A);fetch(A.href,O)}})();function pp(d){return d&&d.__esModule&&Object.prototype.hasOwnProperty.call(d,"default")?d.default:d}var qr={exports:{}},$l={};/**
 * @license React
 ...
 */var qf;function gp(){if(qf)return $l;qf=1;var d=Symbol.for("react.transitional.element"),z=Symbol.for("react.fragment");function v(s,A,O){var R=null;if(O!==void 0&&(R=""+O),A.key!==void 0&&(R=""+A.key),"key"in A){O={};for(var U in A)U!=="key"&&(O[U]=A[U])}else O=A;return A=O.ref,{$$typeof:d,type:s,key:R,ref:A!==void 0?A:null,props:O}}return $l.Fragment=z,$l.jsx=v,$l.jsxs=v,$l}var Hf;function vp(){return Hf||(Hf=1,qr.exports=gp()),qr.exports}var r=vp(),Hr={exports:{}},te={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Lf;function yp(){if(Lf)return te;Lf=1;var d=Symbol.for("react.transitional.element"),z=Symbol.for("react.portal"),v=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),A=Symbol.for("react.profiler"),O=Symbol.for("react.consumer"),R=Symbol.for("react.context"),U=Symbol.for("react.forward_ref"),D=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),Q=Symbol.for("react.lazy"),C=Symbol.for("react.activity"),I=Symbol.iterator;function $(m){return m===null||typeof m!="object"?null:(m=I&&m[I]||m["@@iterator"],typeof m=="function"?m:null)}var G={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},L=Object.assign,P={};function H(m,j,B){this.props=m,this.context=j,this.refs=P,this.updater=B||G}H.prototype.isReactComponent={},H.prototype.setState=function(m,j){if(typeof m!="object"&&typeof m!="function"&&m!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,m,j,"setState")},H.prototype.forceUpdate=function(m){this.updater.enqueueForceUpdate(this,m,"forceUpdate")};function ne(){}ne.prototype=H.prototype;function ue(m,j,B){this.props=m,this.context=j,this.refs=P,this.updater=B||G}var X=ue.prototype=new ne;X.constructor=ue,L(X,H.prototype),X.isPureReactComponent=!0;var xe=Array.isArray;function ge(){}var J={H:null,A:null,T:null,S:null},ae=Object.prototype.hasOwnProperty;function lt(m,j,B){var k=B.ref;return{$$typeof:d,type:m,key:j,ref:k!==void 0?k:null,props:B}}function it(m,j){return lt(m.type,j,m.props)}function ot(m){return typeof m=="object"&&m!==null&&m.$$typeof===d}function We(m){var j={"=":"=0",":":"=2"};return"$"+m.replace(/[=:]/g,function(B){return j[B]})}var ut=/\/+/g;function Bt(m,j){return typeof m=="object"&&m!==null&&m.key!=null?We(""+m.key):j.toString(36)}function ct(m){switch(m.status){case"fulfilled":return m.value;case"rejected":throw m.reason;default:switch(typeof m.status=="string"?m.then(ge,ge):(m.status="pending",m.then(function(j){m.status==="pending"&&(m.status="fulfilled",m.value=j)},function(j){m.status==="pending"&&(m.status="rejected",m.reason=j)})),m.status){case"fulfilled":return m.value;case"rejected":throw m.reason}}throw m}function E(m,j,B,k,ee){var re=typeof m;(re==="undefined"||re==="boolean")&&(m=null);var ce=!1;if(m===null)ce=!0;else switch(re){case"bigint":case"string":case"number":ce=!0;break;case"object":switch(m.$$typeof){case d:case z:ce=!0;break;case Q:return ce=m._init,E(ce(m._payload),j,B,k,ee)}}if(ce)return ee=ee(m),ce=k===""?"."+Bt(m,0):k,xe(ee)?(B="",ce!=null&&(B=ce.replace(ut,"$&/")+"/"),E(ee,j,B,"",function(Nn){return Nn})):ee!=null&&(ot(ee)&&(ee=it(ee,B+(ee.key==null||m&&m.key===ee.key?"":(""+ee.key).replace(ut,"$&/")+"/")+ce)),j.push(ee)),1;ce=0;var Qe=k===""?".":k+":";if(xe(m))for(var we=0;we<m.length;we++)k=m[we],re=Qe+Bt(k,we),ce+=E(k,j,B,re,ee);else if(we=$(m),typeof we=="function")for(m=we.call(m),we=0;!(k=m.next()).done;)k=k.value,re=Qe+Bt(k,we++),ce+=E(k,j,B,re,ee);else if(re==="object"){if(typeof m.then=="function")return E(ct(m),j,B,k,ee);throw j=String(m),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(m).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return ce}function w(m,j,B){if(m==null)return m;var k=[],ee=0;return E(m,k,"","",function(re){return j.call(B,re,ee++)}),k}function F(m){if(m._status===-1){var j=m._result;j=j(),j.then(function(B){(m._status===0||m._status===-1)&&(m._status=1,m._result=B)},function(B){(m._status===0||m._status===-1)&&(m._status=2,m._result=B)}),m._status===-1&&(m._status=0,m._result=j)}if(m._status===1)return m._result.default;throw m._result}var ve=typeof reportError=="function"?reportError:function(m){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof m=="object"&&m!==null&&typeof m.message=="string"?String(m.message):String(m),error:m});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",m);return}console.error(m)},Te={map:w,forEach:function(m,j,B){w(m,function(){j.apply(this,arguments)},B)},count:function(m){var j=0;return w(m,function(){j++}),j},toArray:function(m){return w(m,function(j){return j})||[]},only:function(m){if(!ot(m))throw Error("React.Children.only expected to receive a single React element child.");return m}};return te.Activity=C,te.Children=Te,te.Component=H,te.Fragment=v,te.Profiler=A,te.PureComponent=ue,te.StrictMode=s,te.Suspense=D,te.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=J,te.__COMPILER_RUNTIME={__proto__:null,c:function(m){return J.H.useMemoCache(m)}},te.cache=function(m){return function(){return m.apply(null,arguments)}},te.cacheSignal=function(){return null},te.cloneElement=function(m,j,B){if(m==null)throw Error("The argument must be a React element, but you passed "+m+".");var k=L({},m.props),ee=m.key;if(j!=null)for(re in j.key!==void 0&&(ee=""+j.key),j)!ae.call(j,re)||re==="key"||re==="__self"||re==="__source"||re==="ref"&&j.ref===void 0||(k[re]=j[re]);var re=arguments.length-2;if(re===1)k.children=B;else if(1<re){for(var ce=Array(re),Qe=0;Qe<re;Qe++)ce[Qe]=arguments[Qe+2];k.children=ce}return lt(m.type,ee,k)},te.createContext=function(m){return m={$$typeof:R,_currentValue:m,_currentValue2:m,_threadCount:0,Provider:null,Consumer:null},m.Provider=m,m.Consumer={$$typeof:O,_context:m},m},te.createElement=function(m,j,B){var k,ee={},re=null;if(j!=null)for(k in j.key!==void 0&&(re=""+j.key),j)ae.call(j,k)&&k!=="key"&&k!=="__self"&&k!=="__source"&&(ee[k]=j[k]);var ce=arguments.length-2;if(ce===1)ee.children=B;else if(1<ce){for(var Qe=Array(ce),we=0;we<ce;we++)Qe[we]=arguments[we+2];ee.children=Qe}if(m&&m.defaultProps)for(k in ce=m.defaultProps,ce)ee[k]===void 0&&(ee[k]=ce[k]);return lt(m,re,ee)},te.createRef=function(){return{current:null}},te.forwardRef=function(m){return{$$typeof:U,render:m}},te.isValidElement=ot,te.lazy=function(m){return{$$typeof:Q,_payload:{_status:-1,_result:m},_init:F}},te.memo=function(m,j){return{$$typeof:x,type:m,compare:j===void 0?null:j}},te.startTransition=function(m){var j=J.T,B={};J.T=B;try{var k=m(),ee=J.S;ee!==null&&ee(B,k),typeof k=="object"&&k!==null&&typeof k.then=="function"&&k.then(ge,ve)}catch(re){ve(re)}finally{j!==null&&B.types!==null&&(j.types=B.types),J.T=j}},te.unstable_useCacheRefresh=function(){return J.H.useCacheRefresh()},te.use=function(m){return J.H.use(m)},te.useActionState=function(m,j,B){return J.H.useActionState(m,j,B)},te.useCallback=function(m,j){return J.H.useCallback(m,j)},te.useContext=function(m){return J.H.useContext(m)},te.useDebugValue=function(){},te.useDeferredValue=function(m,j){return J.H.useDeferredValue(m,j)},te.useEffect=function(m,j){return J.H.useEffect(m,j)},te.useEffectEvent=function(m){return J.H.useEffectEvent(m)},te.useId=function(){return J.H.useId()},te.useImperativeHandle=function(m,j,B){return J.H.useImperativeHandle(m,j,B)},te.useInsertionEffect=function(m,j){return J.H.useInsertionEffect(m,j)},te.useLayoutEffect=function(m,j){return J.H.useLayoutEffect(m,j)},te.useMemo=function(m,j){return J.H.useMemo(m,j)},te.useOptimistic=function(m,j){return J.H.useOptimistic(m,j)},te.useReducer=function(m,j,B){return J.H.useReducer(m,j,B)},te.useRef=function(m){return J.H.useRef(m)},te.useState=function(m){return J.H.useState(m)},te.useSyncExternalStore=function(m,j,B){return J.H.useSyncExternalStore(m,j,B)},te.useTransition=function(){return J.H.useTransition()},te.version="19.2.4",te}var Nf;function Vr(){return Nf||(Nf=1,Hr.exports=yp()),Hr.exports}var q=Vr();const bp=pp(q);var Lr={exports:{}},Pl={},Nr={exports:{}},kr={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kf;function xp(){return kf||(kf=1,(function(d){function z(E,w){var F=E.length;E.push(w);e:for(;0<F;){var ve=F-1>>>1,Te=E[ve];if(0<A(Te,w))E[ve]=w,E[F]=Te,F=ve;else break e}}function v(E){return E.length===0?null:E[0]}function s(E){if(E.length===0)return null;var w=E[0],F=E.pop();if(F!==w){E[0]=F;e:for(var ve=0,Te=E.length,m=Te>>>1;ve<m;){var j=2*(ve+1)-1,B=E[j],k=j+1,ee=E[k];if(0>A(B,F))k<Te&&0>A(ee,B)?(E[ve]=ee,E[k]=F,ve=k):(E[ve]=B,E[j]=F,ve=j);else if(k<Te&&0>A(ee,F))E[ve]=ee,E[k]=F,ve=k;else break e}}return w}function A(E,w){var F=E.sortIndex-w.sortIndex;return F!==0?F:E.id-w.id}if(d.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var O=performance;d.unstable_now=function(){return O.now()}}else{var R=Date,U=R.now();d.unstable_now=function(){return R.now()-U}}var D=[],x=[],Q=1,C=null,I=3,$=!1,G=!1,L=!1,P=!1,H=typeof setTimeout=="function"?setTimeout:null,ne=typeof clearTimeout=="function"?clearTimeout:null,ue=typeof setImmediate<"u"?setImmediate:null;function X(E){for(var w=v(x);w!==null;){if(w.callback===null)s(x);else if(w.startTime<=E)s(x),w.sortIndex=w.expirationTime,z(D,w);else break;w=v(x)}}function xe(E){if(L=!1,X(E),!G)if(v(D)!==null)G=!0,ge||(ge=!0,We());else{var w=v(x);w!==null&&ct(xe,w.startTime-E)}}var ge=!1,J=-1,ae=5,lt=-1;function it(){return P?!0:!(d.unstable_now()-lt<ae)}function ot(){if(P=!1,ge){var E=d.unstable_now();lt=E;var w=!0;try{e:{G=!1,L&&(L=!1,ne(J),J=-1),$=!0;var F=I;try{t:{for(X(E),C=v(D);C!==null&&!(C.expirationTime>E&&it());){var ve=C.callback;if(typeof ve=="function"){C.callback=null,I=C.priorityLevel;var Te=ve(C.expirationTime<=E);if(E=d.unstable_now(),typeof Te=="function"){C.callback=Te,X(E),w=!0;break t}C===v(D)&&s(D),X(E)}else s(D);C=v(D)}if(C!==null)w=!0;else{var m=v(x);m!==null&&ct(xe,m.startTime-E),w=!1}}break e}finally{C=null,I=F,$=!1}w=void 0}}finally{w?We():ge=!1}}}var We;if(typeof ue=="function")We=function(){ue(ot)};else if(typeof MessageChannel<"u"){var ut=new MessageChannel,Bt=ut.port2;ut.port1.onmessage=ot,We=function(){Bt.postMessage(null)}}else We=function(){H(ot,0)};function ct(E,w){J=H(function(){E(d.unstable_now())},w)}d.unstable_IdlePriority=5,d.unstable_ImmediatePriority=1,d.unstable_LowPriority=4,d.unstable_NormalPriority=3,d.unstable_Profiling=null,d.unstable_UserBlockingPriority=2,d.unstable_cancelCallback=function(E){E.callback=null},d.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ae=0<E?Math.floor(1e3/E):5},d.unstable_getCurrentPriorityLevel=function(){return I},d.unstable_next=function(E){switch(I){case 1:case 2:case 3:var w=3;break;default:w=I}var F=I;I=w;try{return E()}finally{I=F}},d.unstable_requestPaint=function(){P=!0},d.unstable_runWithPriority=function(E,w){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var F=I;I=E;try{return w()}finally{I=F}},d.unstable_scheduleCallback=function(E,w,F){var ve=d.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?ve+F:ve):F=ve,E){case 1:var Te=-1;break;case 2:Te=250;break;case 5:Te=1073741823;break;case 4:Te=1e4;break;default:Te=5e3}return Te=F+Te,E={id:Q++,callback:w,priorityLevel:E,startTime:F,expirationTime:Te,sortIndex:-1},F>ve?(E.sortIndex=F,z(x,E),v(D)===null&&E===v(x)&&(L?(ne(J),J=-1):L=!0,ct(xe,F-ve))):(E.sortIndex=Te,z(D,E),G||$||(G=!0,ge||(ge=!0,We()))),E},d.unstable_shouldYield=it,d.unstable_wrapCallback=function(E){var w=I;return function(){var F=I;I=w;try{return E.apply(this,arguments)}finally{I=F}}}})(kr)),kr}var Gf;function Sp(){return Gf||(Gf=1,Nr.exports=xp()),Nr.exports}var Gr={exports:{}},at={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Yf;function Tp(){if(Yf)return at;Yf=1;var d=Vr();function z(D){var x="https://react.dev/errors/"+D;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var Q=2;Q<arguments.length;Q++)x+="&args[]="+encodeURIComponent(arguments[Q])}return"Minified React error #"+D+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function v(){}var s={d:{f:v,r:function(){throw Error(z(522))},D:v,C:v,L:v,m:v,X:v,S:v,M:v},p:0,findDOMNode:null},A=Symbol.for("react.portal");function O(D,x,Q){var C=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:A,key:C==null?null:""+C,children:D,containerInfo:x,implementation:Q}}var R=d.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function U(D,x){if(D==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return at.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,at.createPortal=function(D,x){var Q=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(z(299));return O(D,x,null,Q)},at.flushSync=function(D){var x=R.T,Q=s.p;try{if(R.T=null,s.p=2,D)return D()}finally{R.T=x,s.p=Q,s.d.f()}},at.preconnect=function(D,x){typeof D=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,s.d.C(D,x))},at.prefetchDNS=function(D){typeof D=="string"&&s.d.D(D)},at.preinit=function(D,x){if(typeof D=="string"&&x&&typeof x.as=="string"){var Q=x.as,C=U(Q,x.crossOrigin),I=typeof x.integrity=="string"?x.integrity:void 0,$=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;Q==="style"?s.d.S(D,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:C,integrity:I,fetchPriority:$}):Q==="script"&&s.d.X(D,{crossOrigin:C,integrity:I,fetchPriority:$,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},at.preinitModule=function(D,x){if(typeof D=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var Q=U(x.as,x.crossOrigin);s.d.M(D,{crossOrigin:Q,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&s.d.M(D)},at.preload=function(D,x){if(typeof D=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var Q=x.as,C=U(Q,x.crossOrigin);s.d.L(D,Q,{crossOrigin:C,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},at.preloadModule=function(D,x){if(typeof D=="string")if(x){var Q=U(x.as,x.crossOrigin);s.d.m(D,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:Q,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else s.d.m(D)},at.requestFormReset=function(D){s.d.r(D)},at.unstable_batchedUpdates=function(D,x){return D(x)},at.useFormState=function(D,x,Q){return R.H.useFormState(D,x,Q)},at.useFormStatus=function(){return R.H.useHostTransitionStatus()},at.version="19.2.4",at}var Vf;function Ap(){if(Vf)return Gr.exports;Vf=1;function d(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(d)}catch(z){console.error(z)}}return d(),Gr.exports=Tp(),Gr.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xf;function Ep(){if(Xf)return Pl;Xf=1;var d=Sp(),z=Vr(),v=Ap();function s(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function A(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function O(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function R(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function U(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function D(e){if(O(e)!==e)throw Error(s(188))}function x(e){var t=e.alternate;if(!t){if(t=O(e),t===null)throw Error(s(188));return t!==e?null:e}for(var n=e,a=t;;){var l=n.return;if(l===null)break;var i=l.alternate;if(i===null){if(a=l.return,a!==null){n=a;continue}break}if(l.child===i.child){for(i=l.child;i;){if(i===n)return D(l),e;if(i===a)return D(l),t;i=i.sibling}throw Error(s(188))}if(n.return!==a.return)n=l,a=i;else{for(var o=!1,u=l.child;u;){if(u===n){o=!0,n=l,a=i;break}if(u===a){o=!0,a=l,n=i;break}u=u.sibling}if(!o){for(u=i.child;u;){if(u===n){o=!0,n=i,a=l;break}if(u===a){o=!0,a=i,n=l;break}u=u.sibling}if(!o)throw Error(s(189))}}if(n.alternate!==a)throw Error(s(190))}if(n.tag!==3)throw Error(s(188));return n.stateNode.current===n?e:t}function Q(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=Q(e),t!==null)return t;e=e.sibling}return null}var C=Object.assign,I=Symbol.for("react.element"),$=Symbol.for("react.transitional.element"),G=Symbol.for("react.portal"),L=Symbol.for("react.fragment"),P=Symbol.for("react.strict_mode"),H=Symbol.for("react.profiler"),ne=Symbol.for("react.consumer"),ue=Symbol.for("react.context"),X=Symbol.for("react.forward_ref"),xe=Symbol.for("react.suspense"),ge=Symbol.for("react.suspense_list"),J=Symbol.for("react.memo"),ae=Symbol.for("react.lazy"),lt=Symbol.for("react.activity"),it=Symbol.for("react.memo_cache_sentinel"),ot=Symbol.iterator;function We(e){return e===null||typeof e!="object"?null:(e=ot&&e[ot]||e["@@iterator"],typeof e=="function"?e:null)}var ut=Symbol.for("react.client.reference");function Bt(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===ut?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case L:return"Fragment";case H:return"Profiler";case P:return"StrictMode";case xe:return"Suspense";case ge:return"SuspenseList";case lt:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case G:return"Portal";case ue:return e.displayName||"Context";case ne:return(e._context.displayName||"Context")+".Consumer";case X:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case J:return t=e.displayName||null,t!==null?t:Bt(e.type)||"Memo";case ae:t=e._payload,e=e._init;try{return Bt(e(t))}catch{}}return null}var ct=Array.isArray,E=z.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,w=v.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,F={pending:!1,data:null,method:null,action:null},ve=[],Te=-1;function m(e){return{current:e}}function j(e){0>Te||(e.current=ve[Te],ve[Te]=null,Te--)}function B(e,t){Te++,ve[Te]=e.current,e.current=t}var k=m(null),ee=m(null),re=m(null),ce=m(null);function Qe(e,t){switch(B(re,t),B(ee,e),B(k,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?lf(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=lf(t),e=of(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}j(k),B(k,e)}function we(){j(k),j(ee),j(re)}function Nn(e){e.memoizedState!==null&&B(ce,e);var t=k.current,n=of(t,e.type);t!==n&&(B(ee,e),B(k,n))}function fa(e){ee.current===e&&(j(k),j(ee)),ce.current===e&&(j(ce),Jl._currentValue=F)}var ma,el;function Nt(e){if(ma===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);ma=t&&t[1]||"",el=-1<n.stack.indexOf(`
...
`,Ao=(To.basePath||"/").replace(/\/$/,"");function Mg(d){return am(d,Ao,da)}function Pf(d){return tg(d,Ao,da)}function zg(){const[d,z]=q.useState(()=>ag(window.location.pathname,window.location.hash,da,Ao,am)),[v,s]=q.useState(null),[A,O]=q.useState(!0),R=q.useCallback(async(G,L)=>{O(!0),z(G);const P=Pf(G);L!=null&&L.replace?window.history.replaceState(null,"",P):window.history.pushState(null,"",P);const H=await lg(G,da,rg);if(s(H),O(!1),!(L!=null&&L.skipScroll)){const ne=window.location.hash.slice(1);ne?requestAnimationFrame(()=>{const ue=document.getElementById(ne);ue&&ue.scrollIntoView({behavior:"smooth",block:"start"})}):window.scrollTo(0,0)}},[]);q.useEffect(()=>{const G=window.location.hash.slice(1);if(G&&da.some(L=>L.id===G)){const L=Pf(G);window.history.replaceState(null,"",L),R(G,{replace:!0})}else R(d,{replace:!0,skipScroll:!0})},[]),q.useEffect(()=>{const G=()=>{const L=Mg(window.location.pathname);L&&L!==d&&R(L,{replace:!0,skipScroll:!0})};return window.addEventListener("popstate",G),()=>window.removeEventListener("popstate",G)},[d,R]);const U=q.useRef(null),[D,x]=q.useState(()=>typeof document<"u"&&document.documentElement.classList.contains("dark")?"dark":"light");q.useEffect(()=>{const G=new MutationObserver(()=>{const L=document.documentElement.classList.contains("dark");x(L?"dark":"light")});return G.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>G.disconnect()},[]),q.useEffect(()=>{const G=document.querySelectorAll(".tome-mermaid[data-mermaid]");if(G.length===0)return;let L=!1;const P="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs";return(async()=>{try{U.current||(U.current=(await import(P)).default);const H=U.current;if(L)return;const ne=D==="dark",ue=getComputedStyle(document.documentElement).getPropertyValue("--font-body").trim()||"sans-serif";H.initialize({startOnLoad:!1,theme:ne?"dark":"default",fontFamily:ue,flowchart:{padding:15,nodeSpacing:30,rankSpacing:40}});for(let X=0;X<G.length;X++){const xe=G[X],ge=xe.getAttribute("data-mermaid");if(ge)try{const J=atob(ge),{svg:ae}=await H.render(`tome-mermaid-${X}-${Date.now()}`,J);L||(xe.innerHTML=ae)}catch(J){console.warn("[tome] Mermaid render failed:",J),xe.textContent="Diagram rendering failed",xe.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"}}}catch(H){console.warn("[tome] Failed to load mermaid from CDN:",H),G.forEach(ne=>{ne.textContent="Failed to load diagram renderer",ne.style.cssText="padding:16px;color:var(--txM);font-size:13px;border:1px dashed var(--bd);border-radius:2px;text-align:center;"})}})(),()=>{L=!0}},[v,A,D]);const Q=da.map(G=>({id:G.id,title:G.frontmatter.title,description:G.frontmatter.description})),C=da.find(G=>G.id===d),I=ig(C,Wf),$=ng(To.editLink,C==null?void 0:C.filePath);return q.useEffect(()=>{const G=document.querySelectorAll(".tome-math[data-math]").length>0;if(!To.math&&!G)return;const L="tome-katex-css";if(document.getElementById(L))return;const P=document.createElement("link");P.id=L,P.rel="stylesheet",P.href="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.min.css",P.crossOrigin="anonymous",document.head.appendChild(P)},[v,A]),q.useEffect(()=>{const G=document.querySelectorAll(".tome-math[data-math]");if(G.length===0)return;let L=!1;const P="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/katex.mjs";return(async()=>{try{const H=(await import(P)).default;if(L)return;for(const ne of G){const ue=ne.getAttribute("data-math");if(ue)try{const X=atob(ue),xe=ne.classList.contains("tome-math-block");H.render(X,ne,{displayMode:xe,throwOnError:!1})}catch(X){console.warn("[tome] KaTeX render failed:",X)}}}catch(H){console.warn("[tome] Failed to load KaTeX from CDN:",H)}})(),()=>{L=!0}},[v,A]),r.jsxs(r.Fragment,{children:[r.jsx("style",{children:_g}),r.jsx(Pp,{config:To,navigation:og,currentPageId:d,pageHtml:v!=null&&v.isMdx?void 0:A?"<p>Loading...</p>":(v==null?void 0:v.html)||"<p>Page not found</p>",pageComponent:v!=null&&v.isMdx?v.component:void 0,mdxComponents:Eg,pageTitle:(v==null?void 0:v.frontmatter.title)||(A?"Loading...":"Not Found"),pageDescription:v==null?void 0:v.frontmatter.description,headings:(v==null?void 0:v.headings)||[],tocEnabled:(v==null?void 0:v.frontmatter.toc)!==!1,editUrl:$,lastUpdated:C==null?void 0:C.lastUpdated,changelogEntries:v!=null&&v.isMdx||v==null?void 0:v.changelogEntries,onNavigate:R,allPages:Q,docContext:cg,versioning:Wf||void 0,currentVersion:I,basePath:Ao})]})}const em=document.getElementById("tome-root");em&&Mp.createRoot(em).render(r.jsx(zg,{}));export{q as a,bp as e,r as j,Ap as r};
