...
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#D73A49;--shiki-dark:#F97583">import</span><span style="color:#24292E;--shiki-dark:#E1E4E8"> { githubSource, notionSource } </span><span style="color:#D73A49;--shiki-dark:#F97583">from</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> "@tomehq/core/content-source"</span><span style="color:#24292E;--shiki-dark:#E1E4E8">;</span></span>
...
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#D73A49;--shiki-dark:#F97583">import</span><span style="color:#24292E;--shiki-dark:#E1E4E8"> { githubSource } </span><span style="color:#D73A49;--shiki-dark:#F97583">from</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> "@tomehq/core/content-source"</span><span style="color:#24292E;--shiki-dark:#E1E4E8">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">githubSource</span><span style="color:#24292E;--shiki-dark:#E1E4E8">({</span></span>
...
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#D73A49;--shiki-dark:#F97583">import</span><span style="color:#24292E;--shiki-dark:#E1E4E8"> { notionSource } </span><span style="color:#D73A49;--shiki-dark:#F97583">from</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> "@tomehq/core/content-source"</span><span style="color:#24292E;--shiki-dark:#E1E4E8">;</span></span>
<span class="line"></span>
...
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#D73A49;--shiki-dark:#F97583">import</span><span style="color:#24292E;--shiki-dark:#E1E4E8"> { defineContentSource } </span><span style="color:#D73A49;--shiki-dark:#F97583">from</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> "@tomehq/core/content-source"</span><span style="color:#24292E;--shiki-dark:#E1E4E8">;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">  ],</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">};</span></span></code></pre>
<p>Content is fetched once at build time (and on startup in dev mode). Failed sources log a warning but don't block the build — your local pages will still work.</p>
<h2 id="external-group-in-the-sidebar"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#external-group-in-the-sidebar"><span class="icon icon-link"></span></a>External group in the sidebar</h2>
<p>When you use an explicit <code>navigation</code> array in your config, remote pages that are <strong>not</strong> listed in the navigation will automatically appear under an "External" group at the bottom of the sidebar. This ensures fetched content is always accessible even if you haven't manually added every remote page to your navigation config. If you want full control over placement, add the remote page IDs to your <code>navigation</code> array and they will appear in the specified group instead.</p>`,headings:[{depth:2,text:"Configuration",id:"configuration"},{depth:2,text:"GitHub source",id:"github-source"},{depth:3,text:"Private repositories",id:"private-repositories"},{depth:2,text:"Notion source",id:"notion-source"},{depth:3,text:"Setting up the Notion integration",id:"setting-up-the-notion-integration"},{depth:2,text:"Custom content sources",id:"custom-content-sources"},{depth:2,text:"Using multiple sources",id:"using-multiple-sources"},{depth:2,text:"External group in the sidebar",id:"external-group-in-the-sidebar"}],raw:`
