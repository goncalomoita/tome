const e={frontmatter:{title:"CLI Reference",description:"Complete reference for every command and flag in the Tome CLI.",icon:"terminal",hidden:!1,toc:!0,draft:!1},html:`<p>The <code>tome</code> CLI is the primary interface for creating, developing, building, and deploying documentation sites.</p>
...
<hr>
<h3 id="tome-typedoc-files"><a class="heading-anchor" aria-hidden="" tabindex="-1" href="#tome-typedoc-files"><span class="icon icon-link"></span></a><code>tome typedoc &lt;files...&gt;</code></h3>
<p>Generate API reference documentation from TypeScript source files.</p>
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> typedoc</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> src/index.ts</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> typedoc</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> src/index.ts</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> src/utils.ts</span></span></code></pre>
<p>Parses exported functions, interfaces, and type aliases using the TypeScript compiler API. Generates a Markdown page per export with signatures, parameters, return types, and JSDoc descriptions.</p>
<hr>
