 ...
 */var _d;function op(){if(_d)return Bl;_d=1;var v=Symbol.for("react.transitional.element"),O=Symbol.for("react.fragment");function z(f,R,H){var w=null;if(H!==void 0&&(w=""+H),R.key!==void 0&&(w=""+R.key),"key"in R){H={};for(var G in R)G!=="key"&&(H[G]=R[G])}else H=R;return R=H.ref,{$$typeof:v,type:f,key:w,ref:R!==void 0?R:null,props:H}}return Bl.Fragment=O,Bl.jsx=z,Bl.jsxs=z,Bl}var Md;function cp(){return Md||(Md=1,xc.exports=op()),xc.exports}var m=cp(),Tc={exports:{}},J={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Od;function fp(){return Od||(Od=1,(function(v){function O(x,j){var Q=x.length;x.push(j);e:for(;0<Q;){var fe=Q-1>>>1,W=x[fe];if(0<R(W,j))x[fe]=j,x[Q]=W,Q=fe;else break e}}function z(x){return x.length===0?null:x[0]}function f(x){if(x.length===0)return null;var j=x[0],Q=x.pop();if(Q!==j){x[0]=Q;e:for(var fe=0,W=x.length,r=W>>>1;fe<r;){var A=2*(fe+1)-1,C=x[A],q=A+1,K=x[q];if(0>R(C,Q))q<W&&0>R(K,C)?(x[fe]=K,x[q]=Q,fe=q):(x[fe]=C,x[A]=Q,fe=A);else if(q<W&&0>R(K,Q))x[fe]=K,x[q]=Q,fe=q;else break e}}return j}function R(x,j){var Q=x.sortIndex-j.sortIndex;return Q!==0?Q:x.id-j.id}if(v.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var H=performance;v.unstable_now=function(){return H.now()}}else{var w=Date,G=w.now();v.unstable_now=function(){return w.now()-G}}var _=[],y=[],U=1,D=null,X=3,le=!1,be=!1,_e=!1,L=!1,ie=typeof setTimeout=="function"?setTimeout:null,Te=typeof clearTimeout=="function"?clearTimeout:null,Ae=typeof setImmediate<"u"?setImmediate:null;function P(x){for(var j=z(y);j!==null;){if(j.callback===null)f(y);else if(j.startTime<=x)f(y),j.sortIndex=j.expirationTime,O(_,j);else break;j=z(y)}}function Le(x){if(_e=!1,P(x),!be)if(z(_)!==null)be=!0,me||(me=!0,Qe());else{var j=z(y);j!==null&&it(Le,j.startTime-x)}}var me=!1,k=-1,Ce=5,pt=-1;function Bt(){return L?!0:!(v.unstable_now()-pt<Ce)}function gt(){if(L=!1,me){var x=v.unstable_now();pt=x;var j=!0;try{e:{be=!1,_e&&(_e=!1,Te(k),k=-1),le=!0;var Q=X;try{t:{for(P(x),D=z(_);D!==null&&!(D.expirationTime>x&&Bt());){var fe=D.callback;if(typeof fe=="function"){D.callback=null,X=D.priorityLevel;var W=fe(D.expirationTime<=x);if(x=v.unstable_now(),typeof W=="function"){D.callback=W,P(x),j=!0;break t}D===z(_)&&f(_),P(x)}else f(_);D=z(_)}if(D!==null)j=!0;else{var r=z(y);r!==null&&it(Le,r.startTime-x),j=!1}}break e}finally{D=null,X=Q,le=!1}j=void 0}}finally{j?Qe():me=!1}}}var Qe;if(typeof Ae=="function")Qe=function(){Ae(gt)};else if(typeof MessageChannel<"u"){var Lt=new MessageChannel,yt=Lt.port2;Lt.port1.onmessage=gt,Qe=function(){yt.postMessage(null)}}else Qe=function(){ie(gt,0)};function it(x,j){k=ie(function(){x(v.unstable_now())},j)}v.unstable_IdlePriority=5,v.unstable_ImmediatePriority=1,v.unstable_LowPriority=4,v.unstable_NormalPriority=3,v.unstable_Profiling=null,v.unstable_UserBlockingPriority=2,v.unstable_cancelCallback=function(x){x.callback=null},v.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ce=0<x?Math.floor(1e3/x):5},v.unstable_getCurrentPriorityLevel=function(){return X},v.unstable_next=function(x){switch(X){case 1:case 2:case 3:var j=3;break;default:j=X}var Q=X;X=j;try{return x()}finally{X=Q}},v.unstable_requestPaint=function(){L=!0},v.unstable_runWithPriority=function(x,j){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var Q=X;X=x;try{return j()}finally{X=Q}},v.unstable_scheduleCallback=function(x,j,Q){var fe=v.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?fe+Q:fe):Q=fe,x){case 1:var W=-1;break;case 2:W=250;break;case 5:W=1073741823;break;case 4:W=1e4;break;default:W=5e3}return W=Q+W,x={id:U++,callback:j,priorityLevel:x,startTime:Q,expirationTime:W,sortIndex:-1},Q>fe?(x.sortIndex=Q,O(y,x),z(_)===null&&x===z(y)&&(_e?(Te(k),k=-1):_e=!0,it(Le,Q-fe))):(x.sortIndex=W,O(_,x),be||le||(be=!0,me||(me=!0,Qe()))),x},v.unstable_shouldYield=Bt,v.unstable_wrapCallback=function(x){var j=X;return function(){var Q=X;X=j;try{return x.apply(this,arguments)}finally{X=Q}}}})(zc)),zc}var jd;function dp(){return jd||(jd=1,Ec.exports=fp()),Ec.exports}var _c={exports:{}},Fe={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rd;function mp(){if(Rd)return Fe;Rd=1;var v=Dc();function O(_){var y="https://react.dev/errors/"+_;if(1<arguments.length){y+="?args[]="+encodeURIComponent(arguments[1]);for(var U=2;U<arguments.length;U++)y+="&args[]="+encodeURIComponent(arguments[U])}return"Minified React error #"+_+"; visit "+y+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function z(){}var f={d:{f:z,r:function(){throw Error(O(522))},D:z,C:z,L:z,m:z,X:z,S:z,M:z},p:0,findDOMNode:null},R=Symbol.for("react.portal");function H(_,y,U){var D=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:R,key:D==null?null:""+D,children:_,containerInfo:y,implementation:U}}var w=v.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function G(_,y){if(_==="font")return"";if(typeof y=="string")return y==="use-credentials"?y:""}return Fe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=f,Fe.createPortal=function(_,y){var U=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!y||y.nodeType!==1&&y.nodeType!==9&&y.nodeType!==11)throw Error(O(299));return H(_,y,null,U)},Fe.flushSync=function(_){var y=w.T,U=f.p;try{if(w.T=null,f.p=2,_)return _()}finally{w.T=y,f.p=U,f.d.f()}},Fe.preconnect=function(_,y){typeof _=="string"&&(y?(y=y.crossOrigin,y=typeof y=="string"?y==="use-credentials"?y:"":void 0):y=null,f.d.C(_,y))},Fe.prefetchDNS=function(_){typeof _=="string"&&f.d.D(_)},Fe.preinit=function(_,y){if(typeof _=="string"&&y&&typeof y.as=="string"){var U=y.as,D=G(U,y.crossOrigin),X=typeof y.integrity=="string"?y.integrity:void 0,le=typeof y.fetchPriority=="string"?y.fetchPriority:void 0;U==="style"?f.d.S(_,typeof y.precedence=="string"?y.precedence:void 0,{crossOrigin:D,integrity:X,fetchPriority:le}):U==="script"&&f.d.X(_,{crossOrigin:D,integrity:X,fetchPriority:le,nonce:typeof y.nonce=="string"?y.nonce:void 0})}},Fe.preinitModule=function(_,y){if(typeof _=="string")if(typeof y=="object"&&y!==null){if(y.as==null||y.as==="script"){var U=G(y.as,y.crossOrigin);f.d.M(_,{crossOrigin:U,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0})}}else y==null&&f.d.M(_)},Fe.preload=function(_,y){if(typeof _=="string"&&typeof y=="object"&&y!==null&&typeof y.as=="string"){var U=y.as,D=G(U,y.crossOrigin);f.d.L(_,U,{crossOrigin:D,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0,type:typeof y.type=="string"?y.type:void 0,fetchPriority:typeof y.fetchPriority=="string"?y.fetchPriority:void 0,referrerPolicy:typeof y.referrerPolicy=="string"?y.referrerPolicy:void 0,imageSrcSet:typeof y.imageSrcSet=="string"?y.imageSrcSet:void 0,imageSizes:typeof y.imageSizes=="string"?y.imageSizes:void 0,media:typeof y.media=="string"?y.media:void 0})}},Fe.preloadModule=function(_,y){if(typeof _=="string")if(y){var U=G(y.as,y.crossOrigin);f.d.m(_,{as:typeof y.as=="string"&&y.as!=="script"?y.as:void 0,crossOrigin:U,integrity:typeof y.integrity=="string"?y.integrity:void 0})}else f.d.m(_)},Fe.requestFormReset=function(_){f.d.r(_)},Fe.unstable_batchedUpdates=function(_,y){return _(y)},Fe.useFormState=function(_,y,U){return w.H.useFormState(_,y,U)},Fe.useFormStatus=function(){return w.H.useHostTransitionStatus()},Fe.version="19.2.4",Fe}var Ud;function hp(){if(Ud)return _c.exports;Ud=1;function v(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(v)}catch(O){console.error(O)}}return v(),_c.exports=mp(),_c.exports}/**
 * @license React
...
`},{id:"reference/config",title:"Config Reference",content:'\n# Config reference\n\nThe config file (`tome.config.js`, `.mjs`, or `.ts`) is validated at startup. Invalid values produce clear error messages with the field path and expected type.\n\n## Top-level fields\n\n| Field | Type | Default | Description |\n|-------|------|---------|-------------|\n| `name` | `string` | `"My Docs"` | Site name shown in the header and browser tab |\n| `logo` | `string` | — | Path to logo image, relative to `public/` |\n| `favicon` | `string` | — | Path to favicon, relative to `public/` |\n| `baseUrl` | `string` | — | Full URL where the site is hosted (for analytics, canonical links) |\n| `basePath` | `string` | — | URL subpath prefix (e.g., `"/docs/"`) — sets Vite\'s `base` option |\n| `theme` | `ThemeConfig` | `{}` | Theme configuration (see below) |\n| `navigation` | `NavigationGroup[]` | `[]` | Sidebar navigation structure |\n| `topNav` | `TopNavItem[]` | — | Header navigation links |\n| `search` | `SearchConfig` | `{ provider: "local" }` | Search provider configuration |\n| `api` | `ApiConfig` | — | OpenAPI spec and playground settings |\n| `ai` | `AiConfig` | — | AI chat widget configuration |\n| `mcp` | `McpConfig` | `{ enabled: true }` | MCP server manifest generation |\n| `i18n` | `I18nConfig` | — | Internationalization settings |\n| `versioning` | `VersioningConfig` | — | Multi-version documentation |\n| `analytics` | `AnalyticsConfig` | — | Analytics provider settings |\n\n## ThemeConfig\n\n| Field | Type | Default | Description |\n|-------|------|---------|-------------|\n| `preset` | `"amber" \\| "editorial"` | `"amber"` | Base theme preset |\n| `accent` | `string` | — | Custom accent color (hex, e.g., `"#ff6b4a"`) |\n| `mode` | `"light" \\| "dark" \\| "auto"` | `"auto"` | Color mode |\n| `fonts.heading` | `strin'}],Ld={info:{color:"#3b82f6",label:"INFO"},warning:{color:"#f59e0b",label:"WARNING"},tip:{color:"var(--ac, #a78bfa)",label:"TIP"},danger:{color:"#ef4444",label:"DANGER"}};function Wp({type:v="info",title:O,children:z}){const f=Ld[v]||Ld.info;return m.jsxs("div",{style:{borderLeft:`3px solid ${f.color}`,background:`${f.color}11`,borderRadius:"0 2px 2px 0",padding:"14px 18px",marginBottom:20},children:[O?m.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginBottom:4},children:[m.jsx("span",{style:{fontWeight:700,fontSize:10,letterSpacing:".08em",color:f.color,fontFamily:"var(--font-code, monospace)"},children:f.label}),m.jsx("span",{style:{fontWeight:600,fontSize:13,color:f.color},children:O})]}):m.jsx("div",{style:{marginBottom:4},children:m.jsx("span",{style:{fontWeight:700,fontSize:10,letterSpacing:".08em",color:f.color,fontFamily:"var(--font-code, monospace)"},children:f.label})}),m.jsx("div",{style:{fontSize:14,lineHeight:1.65,color:"var(--tx2)"},children:z})]})}function Fp({items:v,children:O}){const[z,f]=Z.useState(0);return m.jsxs("div",{style:{marginBottom:20},children:[m.jsx("div",{style:{display:"flex",gap:0,borderBottom:"1px solid var(--bd)"},children:v.map((R,H)=>m.jsx("button",{onClick:()=>f(H),style:{padding:"8px 16px",background:"none",border:"none",borderBottom:z===H?"2px solid var(--ac)":"2px solid transparent",color:z===H?"var(--ac)":"var(--txM)",fontWeight:z===H?600:400,fontSize:13,cursor:"pointer",fontFamily:"inherit"},children:R},H))}),m.jsx("div",{style:{padding:"16px 0"},children:O[z]})]})}function $p({title:v,icon:O,href:z,children:f}){const R=m.jsxs("div",{style:{border:"1px solid var(--bd)",borderRadius:2,padding:"20px",transition:"border-color 0.15s",cursor:z?"pointer":"default"},children:[O&&m.jsx("span",{style:{fontSize:24,marginBottom:8,display:"block"},children:O}),m.jsx("div",{style:{fontWeight:600,fontSize:14,marginBottom:4},children:v}),f&&m.jsx("div",{style:{fontSize:13,color:"var(--txM)",lineHeight:1.5},children:f})]});return z?m.jsx("a",{href:z,style:{textDecoration:"none",color:"inherit"},children:R}):R}function Ip({cols:v=2,children:O}){return m.jsx("div",{style:{display:"grid",gridTemplateColumns:`repeat(${v}, 1fr)`,gap:12,marginBottom:20},children:O})}function Pp({children:v}){return m.jsx("div",{style:{paddingLeft:24,borderLeft:"2px solid var(--bd)",marginBottom:20},children:rp.Children.map(v,(O,z)=>m.jsxs("div",{style:{position:"relative",paddingBottom:20},children:[m.jsx("div",{style:{position:"absolute",left:-33,top:0,width:20,height:20,borderRadius:"50%",background:"var(--ac)",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700},children:z+1}),m.jsx("div",{style:{paddingLeft:8},children:O})]}))})}function eg({title:v,children:O}){const[z,f]=Z.useState(!1);return m.jsxs("div",{style:{border:"1px solid var(--bd)",borderRadius:2,marginBottom:8,overflow:"hidden"},children:[m.jsxs("button",{onClick:()=>f(!z),style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%",padding:"12px 16px",background:"var(--sf)",border:"none",cursor:"pointer",fontWeight:500,fontSize:14,color:"var(--tx)",fontFamily:"inherit"},children:[v,m.jsx("span",{style:{transform:z?"rotate(180deg)":"rotate(0)",transition:"transform 0.2s"},children:"▾"})]}),z&&m.jsx("div",{style:{padding:"12px 16px",borderTop:"1px solid var(--bd)",fontSize:14,color:"var(--tx2)",lineHeight:1.65},children:O})]})}const tg={Callout:Wp,Tabs:Fp,Card:$p,CardGroup:Ip,Steps:Pp,Accordion:eg},ng=`
...
`;async function ag(v){try{const O=wl.find(f=>f.id===v),z=await kp(v);return O!=null&&O.isMdx&&z.meta?{isMdx:!0,component:z.default,frontmatter:z.meta.frontmatter,headings:z.meta.headings}:z.default?{isMdx:!1,...z.default}:null}catch(O){return console.error(`Failed to load page: ${v}`,O),null}}function lg(){const[v,O]=Z.useState(()=>{var y;const _=window.location.hash.slice(1);return _&&wl.some(U=>U.id===_)?_:((y=wl[0])==null?void 0:y.id)||"index"}),[z,f]=Z.useState(null),[R,H]=Z.useState(!0),w=Z.useCallback(async _=>{H(!0),O(_),window.location.hash=_;const y=await ag(_);f(y),H(!1)},[]);Z.useEffect(()=>{w(v)},[]),Z.useEffect(()=>{const _=()=>{const y=window.location.hash.slice(1);y&&y!==v&&wl.some(U=>U.id===y)&&w(y)};return window.addEventListener("hashchange",_),()=>window.removeEventListener("hashchange",_)},[v,w]);const G=wl.map(_=>({id:_.id,title:_.frontmatter.title,description:_.frontmatter.description}));return m.jsxs(m.Fragment,{children:[m.jsx("style",{children:ng}),m.jsx(Xp,{config:Vp,navigation:Zp,currentPageId:v,pageHtml:z!=null&&z.isMdx?void 0:R?"<p>Loading...</p>":(z==null?void 0:z.html)||"<p>Page not found</p>",pageComponent:z!=null&&z.isMdx?z.component:void 0,mdxComponents:tg,pageTitle:(z==null?void 0:z.frontmatter.title)||(R?"Loading...":"Not Found"),pageDescription:z==null?void 0:z.frontmatter.description,headings:(z==null?void 0:z.headings)||[],onNavigate:w,allPages:G,docContext:Jp})]})}const wd=document.getElementById("tome-root");wd&&yp.createRoot(wd).render(m.jsx(lg,{}));export{Z as a,rp as e,hp as r};
