...
<li><strong>Agent-friendly</strong> — Every build generates <code>llms.txt</code>, <code>skill.md</code>, <code>robots.txt</code>, <code>search.json</code>, <code>mcp.json</code>, and JSON-LD schema markup. Your docs work for humans and machines.</li>
<li><strong>Mermaid and math</strong> — Diagrams and LaTeX math render in both <code>.md</code> and <code>.mdx</code> files with zero config.</li>
