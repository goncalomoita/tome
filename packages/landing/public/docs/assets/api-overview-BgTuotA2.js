...
<ul>
<li><strong><a href="v1/api-endpoints">Endpoints</a></strong> for details on how endpoints are rendered</li>
<li><strong><a href="v1/api-auth">Authentication</a></strong> for configuring auth in the playground</li>
...
- **[Endpoints](v1/api-endpoints)** for details on how endpoints are rendered
- **[Authentication](v1/api-auth)** for configuring auth in the playground
`};export{e as default};
