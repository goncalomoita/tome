...
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npx</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> migrate</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> gitbook</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> ./path-to-gitbook-project</span></span></code></pre>
...
<span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npx</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> migrate</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> gitbook</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> ./gitbook-docs</span><span style="color:#005CC5;--shiki-dark:#79B8FF"> --out</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> ./my-new-docs</span></span>
...
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npx</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> migrate</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> mintlify</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> ./path-to-mintlify-project</span></span></code></pre>
...
<tbody>
<tr>
<td><code>mint.json</code> navigation</td>
<td><code>tome.config.js</code> navigation array</td>
</tr>
<tr>
<td><code>mint.json</code> colors</td>
<td><code>tome.config.js</code> theme accent</td>
</tr>
<tr>
<td><code>mint.json</code> logo / favicon</td>
<td><code>tome.config.js</code> logo / favicon</td>
</tr>
<tr>
<td><code>mint.json</code> topbar links</td>
<td><code>tome.config.js</code> topNav</td>
</tr>
<tr>
<td><code>mint.json</code> redirects</td>
<td><code>tome.config.js</code> redirects</td>
</tr>
<tr>
<td><code>mint.json</code> openapi</td>
...
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#6A737D;--shiki-dark:#6A737D"># Output to a specific directory</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npx</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> migrate</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> mintlify</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> ./mintlify-docs</span><span style="color:#005CC5;--shiki-dark:#79B8FF"> --out</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> ./my-new-docs</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A737D;--shiki-dark:#6A737D"># Preview without writing files</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npx</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> migrate</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> mintlify</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> ./mintlify-docs</span><span style="color:#005CC5;--shiki-dark:#79B8FF"> --dry-run</span></span></code></pre>
<hr>
...
<p>See the <a href="/docs/guides/redirects">Redirects guide</a> for more on how redirects work.</p>
...
<pre class="shiki shiki-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npx</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> login</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npx</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> tome</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> deploy</span></span></code></pre>
