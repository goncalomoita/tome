...
<CardGroup cols={2}>
  <Card title="Tutorials" href="./tutorials/first-site" icon="book">
    Step-by-step walkthroughs to get started and deploy your first site.
  </Card>
  <Card title="Guides" href="./guides/search" icon="compass">
    How-to recipes for search, theming, migration, and more.
  </Card>
  <Card title="Reference" href="./reference/cli" icon="terminal">
