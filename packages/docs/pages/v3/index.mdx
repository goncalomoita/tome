...
<CardGroup cols={2}>
  <Card title="Tutorials" href="./quickstart" icon="📚">
    Step-by-step walkthroughs to get started and deploy your first site.
  </Card>
  <Card title="Guides" href="./guides/configuration" icon="📖">
    How-to recipes for search, theming, migration, and more.
  </Card>
  <Card title="Reference" href="./reference/config" icon="📋">
    Complete specs for config, CLI, components, and frontmatter.
  </Card>
  <Card title="Concepts" href="./concepts/architecture" icon="💡">
    Architecture, file routing, and how Tome works under the hood.
  </Card>
</CardGroup>
